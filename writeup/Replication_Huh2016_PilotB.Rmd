...
t.test(d_tidy_pref_set$cross_mean, d_tidy_pref_set$within_mean, paired = TRUE)
t.test(d_tidy_pref_set$target_mean, d_tidy_pref_set$within_mean, paired = TRUE)
t.test(d_tidy_pref_set$cross_mean, d_tidy_pref_set$target_mean, paired = TRUE)
